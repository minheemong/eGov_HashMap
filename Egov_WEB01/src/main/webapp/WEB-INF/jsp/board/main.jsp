...
<table class="list">
	<tr><td colspan="5" style="border: white; text-align: right">
		<div style="float:left;">${loginUser.id}(${loginUser.name})님 로그인 
			...
			<input type="button" value="로그아웃"	onClick="location.href='logout.do'"></div>
		<div style="float:right;"><a href="boardWriteForm.do">게시글 등록</a></div>	</td></tr>
...
<div id="paging" align="center" style="font-size:110%;">
	<c:url var="action" value="/boardList.do"/>
