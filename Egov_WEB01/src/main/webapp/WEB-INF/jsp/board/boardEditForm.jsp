...
<h1>게시글 수정</h1>
<form name="frm" method="post", action="boardUpdate.do" encType="multipart/form-data">
	...
	<tr><th>이미지</th><td>
		<c:choose>
			<c:when test="${empty board.imgfilename}">
				<img src="<c:url value='/images/noname.jpg'/>" height="80" width="80"><br>
			</c:when>
			<c:otherwise>
				<img src="<c:url value='/images/${board.imgfilename}'/>" height="80" width="80"><br>
			</c:otherwise>
		</c:choose>
